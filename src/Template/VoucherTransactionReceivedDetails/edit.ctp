...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $voucherTransactionReceivedDetail->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $voucherTransactionReceivedDetail->id)]
            )
        ?></li>
...
<div class="voucherTransactionReceivedDetails form large-9 medium-8 columns content">
    <?= $this->Form->create($voucherTransactionReceivedDetail) ?>
    <fieldset>
        <legend><?= __('Edit Voucher Transaction Received Detail') ?></legend>
        <?php
